...
class TestNanPhysics(unittest.TestCase):
    ...
    def test_7_monotonicity(self):
        ...
        k_vf1 = nan_thermal_conductivity(V_f=0.05, k_m=0.25, k_f_axial=100.0,
                                         k_f_transverse=10.0, aspect_ratio=10.0,
                                         geometry='fiber', radius_nm=100.0, a_K_nm=0.1)
        k_vf2 = nan_thermal_conductivity(V_f=0.20, k_m=0.25, k_f_axial=100.0,
                                         k_f_transverse=10.0, aspect_ratio=10.0,
                                         geometry='fiber', radius_nm=100.0, a_K_nm=0.1)
        self.assertGreater(k_vf2, k_vf1, "k_eff should increase as V_f increases.")
        
        # 7b: Monotonicity with respect to filler conductivity
        k_kf1 = nan_thermal_conductivity(V_f=0.10, k_m=0.25, k_f_axial=10.0,
                                         k_f_transverse=10.0, aspect_ratio=10.0,
                                         geometry='fiber', radius_nm=100.0, a_K_nm=0.1)
        k_kf2 = nan_thermal_conductivity(V_f=0.10, k_m=0.25, k_f_axial=100.0,
    ...
    def test_8_stability_filler_library(self):
        ...
        library = {
            ...
            'Graphene Nanoplatelets': {
                'k_ax': 3000.0, 'k_tr': 300.0, 'ar': 1000.0, 'geom': 'platelet', 'rad': 10.0
            },
            'Glass Fiber': {
